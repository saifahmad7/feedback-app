...
<nav class="navbar navbar-expand-lg navbar-dark">
  <a class="navbar-brand" href="/feedback_app/index.jsp">Feedback Application</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="/feedback_app/index.jsp">Home</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/feedback_app/about.jsp">About</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/feedback_app/contact.jsp">Contact Us</a>
      </li>
    </ul>
